    ...
    <div class="right-box">
      <div class="content-box">
        ...
        <label for="username" class="form-input mar-btm-20 mar-top-45">
          <input type="text" value="1@qq.com" id="username">
          <span class="label" id="username-wrap">Email</span>
        </label>
        <label for="password" class="form-input">
          <input type="password" value="A123456789" id="password">
          <span class="label" id="password-wrap">Password</span>
        </label>
        <div class="login-btn hide-load" id="submit-btn">
